...
public class ButtonPrompt : MonoBehaviour
{
    ...
    public virtual void Show()
    {
        ...
        ContainerCanvasGroup.alpha = 0f;
        StartCoroutine(Fade.FadeCanvasGroup(ContainerCanvasGroup, FadeInDuration, 1f, true));
    }
    ...
    protected virtual IEnumerator HideCo()
    {
        ...
        StartCoroutine(Fade.FadeCanvasGroup(ContainerCanvasGroup, FadeOutDuration, 0f, true));
